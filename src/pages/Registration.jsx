...
function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(
                "https://backend-node-mongodb-lwi6.onrender.com/users/register",
                {
                    method: "POST",
                    headers: {
    ...
    const inputClass =
        "w-full bg-green-100/50 border border-green-200 text-gray-800 placeholder-gray-400 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent";
                ...
                <div className="bg-green-50/70 backdrop-blur-sm rounded-xl p-8 border border-green-200/60 shadow-lg shadow-green-200/20">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-400 hover:to-teal-400 text-white p-3 rounded-lg font-medium transition-all disabled:opacity-50 cursor-pointer shadow-lg shadow-green-400/25"
                        >
